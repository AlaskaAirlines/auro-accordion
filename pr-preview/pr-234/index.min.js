...
class AuroAccordionGroup extends i$2 {
  ...
  static get properties() {
    return {
      ...
      /**
       * If set, removes all trigger padding for every accordion in the group so slotted trigger content controls the trigger size.
       */
      noSpacing: {
        type: Boolean,
        attribute: "no-spacing",
        reflect: true,
      },
  ...
  handleSlotContentChange() {
    ...
    this.items.forEach((item) => {
      ...
      if (this.hasAttribute("no-spacing")) {
        item.setAttribute("no-spacing", "");
      }
...
class AuroAccordion extends i$2 {
  ...
  static get properties() {
    return {
      ...
      /**
       * If set, removes all trigger padding so slotted trigger content controls the trigger size. Best paired with `chevron="none"` for a fully flush trigger.
       */
      noSpacing: {
        type: Boolean,
        attribute: "no-spacing",
